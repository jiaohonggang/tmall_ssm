...
public class FileTester {
	...
	public void tester() {
		...
		File writeFile = new File("D:/test/result.txt");
...
//			BufferedWriter writer = new BufferedWriter(write);
			FileWriter writer = new FileWriter("D:/test/result.txt", true);
			...
			while ((tempString = reader.readLine()) != null) {
				...
				if (tempString.startsWith("-")) {
					...
					if (tempString.startsWith("*")) {
						...
						writer.write("            <a class=\"hot-word  highlight\" href=\"/searchProduct?keyword="
								+ tempString + "\">" + tempString + "</a>\r\n");
					} else {
						writer.write("            <a class=\"hot-word \" href=\"/searchProduct?keyword=" + tempString
								+ "\">" + tempString + "</a>\r\n");
					}
				}
